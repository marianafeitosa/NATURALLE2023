    ...
    <div class="container">
      ...
      <nav class="navbar" data-navbar>
        ...
        <ul class="navbar-list">
          ...
          <li class="navbar-item">
            <a href="avaliacao.php" class="navbar-link hover-underline">
              <div class="separator"></div>

              <span class="span">Avaliações</span>
            </a>
          </li>
...
.cart-link {
        ...
        .cart-count {
            ...
            border-radius: 50%; /* Deixe o contador redondo */
            padding: 4px 8px; /* Espaçamento interno do contador */
            font-size: 12px; /* Tamanho do texto do contador */
            margin-left: 4px; /* Adiciona um espaçamento à esquerda do contador */
        }
...
#profile {
    ...
    width: 300px;
    position: absolute;
    top: 120px; /* Ajuste a posição vertical como desejado */
    right: 10px; /* Ajuste a posição horizontal como desejado */
    z-index: 999; /* Defina um valor alto para a propriedade z-index */
...
.profile-icons a {
    display: flex;
    align-items: center;
    margin-top: 10px; /* Ajuste o espaçamento entre os ícones conforme necessário */
}
