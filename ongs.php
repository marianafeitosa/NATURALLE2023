...
include ('header.php');
    ...
    <div class="card">
        <div class="img">
            <img src="assets/images/MUNDOSEMFOME.png" width="200" height="205">
        </div>
    ...
    <div class="card">
        <div class="img">
            <img src="assets/images/CRIANCASFELIZES.png" width="210">
        </div>
    ...
    <div class="card">
        <div class="img">
            <img src="assets/images/AMORECURA.png" width="200" height="205">
        </div>
