...
<br>
   ...
   <div class="box-container">
      ...
      <div class="box">
         ...
         <a href="shop.php" class="btn">Pratos</a>
      </div>
      ...
      <div class="box">
         ...
         <a href="category.php?category=meat" class="btn">Sobremesas</a>
      </div>
      ...
      <div class="box">
         ...
         <a href="category.php?category=vegitables" class="btn">Bebidas</a>
      </div>
      ...
      <div class="box">
         ...
         <a href="SaborSolidario.php" class="btn">Saiba Mais</a>
      </div>
...
<section class="products">
   ...
   <form action="" class="box" method="POST">
      <div class="price">R$<span><?= $fetch_products['price']; ?></span>,00</div>
